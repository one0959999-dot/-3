"""
claude_api.py
GeminiApi와 완전히 동일한 인터페이스 — gemini_api.py를 대체하는 Claude(Anthropic) 버전.
bots/bot_manager.py에서 AI_PROVIDER 설정 한 줄로 전환 가능.
"""
...
class ClaudeApi:
    """라씨 AI - Claude(Anthropic)를 활용한 주식 분석 엔진 (GeminiApi 호환 인터페이스)"""
