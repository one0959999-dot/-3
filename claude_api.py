...
- 답변은 간결하고 실용적이어야 합니다."""
    ...
    DEFAULT_MODEL  = os.environ.get("LASSI_CLAUDE_MODEL",       "claude-sonnet-4-5")
    _FAST_MODEL    = os.environ.get("LASSI_CLAUDE_FAST_MODEL",  "claude-haiku-3-5")
    _SMART_MODEL   = os.environ.get("LASSI_CLAUDE_SMART_MODEL", "claude-sonnet-4-5")
