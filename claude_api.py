...
- 답변은 간결하고 실용적이어야 합니다."""
    ...
    # 기본 모델: claude-3-5-sonnet-20241022 (검증된 최신 안정 버전)
    # 더 빠른 응답이 필요하면: claude-3-5-haiku-20241022
    # 더 정확한 분석이 필요하면: claude-3-5-sonnet-20241022
    DEFAULT_MODEL = "claude-3-5-sonnet-20241022"  # [BUG-N3] claude-opus-4-5 → 검증된 모델 ID
