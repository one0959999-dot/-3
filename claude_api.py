...
- 답변은 간결하고 실용적이어야 합니다."""
    ...
    # [BUG-10] 레퍼런스 파일 경로를 환경변수로 재정의 가능하도록 수정.
    # 기본값: Windows 개발 PC 기준. EC2/Linux 환경에서는 LASSI_REF_DIR 환경변수를 설정하세요.
    _REF_BASE_DIR: str = os.environ.get(
        "LASSI_REF_DIR",
    ...
    _REF_FILES: list = [os.path.join(_REF_BASE_DIR, fn) for fn in _REF_FILENAMES]
