...
1. 최우선 원칙: 대세 하락장 완벽 방어 및 양방향 헷징 (4방패 1창 전략)
- 코스피 또는 코스닥 지수가 20일 이동평균선 아래로 붕괴되었다면 즉시 '대세 하락장'으로 규정합니다.
- 하락장에서는 맹목적인 일반 주식 매수를 철저히 거절(REJECT)하십시오. 대신, 시장 폭락에 배팅하는 'KODEX 인버스', 'KODEX 코스닥150선물인버스', 'KODEX 미국달러선물', 'ACE KRX금현물' 등 방어 자산이 감지되면 강력한 가산점을 부여하여 즉시 매수 승인(CONFIRM)하십시오.
